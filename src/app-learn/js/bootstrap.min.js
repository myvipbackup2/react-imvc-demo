...
+(function (a) {
  ...
  if (
    (b[0] < 2 && b[1] < 9) || (b[0] == 1 && b[1] == 9 && b[2] < 1) || b[0] > 3
  ) {
    throw new Error(
  ...
  function b (b) {
    return this.each(function () {
      var d = a(this), e = d.data('bs.button'), f = typeof b === 'object' && b
      e ||
        d.data(
          'bs.button',
          e = new c(this, f)
  ...
  c.VERSION = '3.3.7', c.DEFAULTS = {
    ...
    var c = 'disabled',
      ...
      f = d.data()
    b += 'Text', f.resetText == null && d.data('resetText', d[e]()), setTimeout(
      a.proxy(
        function () {
          d[e](f[b] == null ? this.options[b] : f[b]), b == 'loadingText'
  ...
  function b (b) {
    return this.each(function () {
      var d = a(this),
        ...
        g = typeof b === 'string' ? b : f.slide
      e ||
        d.data(
          'bs.carousel',
          e = new c(this, f)
        ), typeof b === 'number' ? e.to(b) : g ? e[g]() : f.interval && e.pause().cycle()
    })
  }
  var c = function (b, c) {
  ...
  c.VERSION = '3.3.7', c.TRANSITION_DURATION = 600, c.DEFAULTS = {
    ...
    var e = a == 'prev' ? -1 : 1, f = (c + e) % this.$items.length
  ...
  function c (b) {
    return this.each(function () {
      var c = a(this),
        ...
        f = a.extend({}, d.DEFAULTS, c.data(), typeof b === 'object' && b)
      !e &&
        f.toggle &&
        /show|hide/.test(b) &&
        (f.toggle = !1), e || c.data('bs.collapse', e = new d(this, f)), typeof b === 'string' && e[b]()
    })
  }
  var d = function (b, c) {
    this.$element = a(b), this.options = a.extend(
    ...
    if (
      ...
      if (
        ...
        if ((!g && c.which != 27) || (g && c.which == 27)) {
          return c.which == 27 && e.find(f).trigger('focus'), d.trigger(
            'click'
          )
        }
  ...
  function b (b, d) {
    return this.each(function () {
      var e = a(this),
        f = e.data('bs.modal'),
        g = a.extend({}, c.DEFAULTS, e.data(), typeof b === 'object' && b)
      f ||
        e.data(
          'bs.modal',
          f = new c(this, g)
  ...
  function b (b) {
    return this.each(function () {
      var d = a(this), e = d.data('bs.tooltip'), f = typeof b === 'object' && b;
      (!e && /destroy|hide/.test(b)) ||
        (e || d.data('bs.tooltip', e = new c(this, f)), typeof b === 'string' &&
          e[b]())
    })
  }
  var c = function (a, b) {
  ...
  c.VERSION = '3.3.7', c.TRANSITION_DURATION = 150, c.DEFAULTS = {
    ...
    return c ||
      ...
      (c.inState[
        b.type == 'focusin' ? 'focus' : 'hover'
      ] = !0), c.tip().hasClass('in') || c.hoverState == 'in'
    ...
    if (this.hasContent() && this.enabled) {
      ...
      var h = typeof this.options.placement === 'function'
      ...
      if (j) {
        ...
        h = h == 'bottom' && k.bottom + m > o.bottom
          ? 'top'
          : h == 'top' && k.top - m < o.top
              ? 'bottom'
      ...
      var q = function () {
        var a = e.hoverState
        e.$element.trigger('shown.bs.' + e.type), e.hoverState = null, a ==
          'out' &&
          e.leave(e)
      }
    ...
    function d () {
      e.hoverState != 'in' && f.detach(), e.$element &&
        e.$element
    ...
    b = b || this.$element
    var c = b[0], d = c.tagName == 'BODY', e = c.getBoundingClientRect()
    e.width == null &&
      (e = a.extend({}, e, {
  ...
  function b (b) {
    return this.each(function () {
      var d = a(this), e = d.data('bs.popover'), f = typeof b === 'object' && b;
      (!e && /destroy|hide/.test(b)) ||
        (e || d.data('bs.popover', e = new c(this, f)), typeof b === 'string' &&
          e[b]())
    })
  }
  var c = function (a, b) {
  ...
  c.VERSION = '3.3.7', c.DEFAULTS = a.extend(
    ...
    a.find('.popover-title')[this.options.html ? 'html' : 'text'](b), a
      ...
      .detach()
      .end()[
        this.options.html ? typeof c === 'string' ? 'html' : 'append' : 'text'
  ...
  function b (c, d) {
    this.$body = a(document.body), this.$scrollElement = a(
      ...
      ' .nav li > a', this.offsets = [], this.targets = [
  ...
  function b (b) {
    return this.each(function () {
      var d = a(this), e = d.data('bs.affix'), f = typeof b === 'object' && b
      e ||
        d.data('bs.affix', e = new c(this, f)), typeof b === 'string' && e[b]()
    })
  }
  var c = function (b, d) {
  ...
  c.VERSION = '3.3.7', c.RESET = 'affix affix-top affix-bottom', c.DEFAULTS = {
    ...
    var h = this.affixed == null, i = h ? e : f.top, j = h ? g : b
    return c != null && e <= c
      ? 'top'
    ...
    if (this.$element.is(':visible')) {
      ...
      typeof d !== 'object' && (f = e = d), typeof e === 'function' &&
        (e = d.top(this.$element)), typeof f === 'function' &&
      ...
      if (this.affixed != h) {
        ...
        this.affixed = h, this.unpin = h == 'bottom'
  ...
  a.fn.affix = b, a.fn.affix.Constructor = c, a.fn.affix.noConflict = function () {
    ...
    a('[data-spy="affix"]').each(function () {
      ...
      d.offset = d.offset || {
      }, d.offsetBottom != null && (d.offset.bottom = d.offsetBottom), d.offsetTop != null && (d.offset.top = d.offsetTop), b.call(c, d)
    })
  })
})(jQuery)
