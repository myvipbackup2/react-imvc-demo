...
!(function (a, b) {
  ...
  n.fn = n.prototype = {
    ...
    var a,
      ...
      j = !1
    for (
      typeof g === 'boolean' && (j = g, g = arguments[h] || {}, h++), typeof g ===
        'object' ||
        n.isFunction(g) ||
        (g = {}), h === i && (g = this, h--);
      i > h;
    ...
    proxy: function (a, b) {
      var c, e, f
      return typeof b === 'string' && (c = a[b], b = a, a = c), n.isFunction(a)
  ...
  var t = (function (a) {
    ...
    function ga (a, b, d, e) {
      ...
      if (!e && p) {
        ...
        if (c.qsa && (!q || !q.test(a))) {
          if (
            (s = r = u, w = b, x = k !== 1 && a, k === 1 &&
              b.nodeName.toLowerCase() !== 'object')
          ) {
    ...
    c = ga.support = {}, f = ga.isXML = function (a) {
      ...
      return g !== n && g.nodeType === 9 && g.documentElement
        ? (n = g, o = g.documentElement, e = g.defaultView, e &&
            ...
            (e.addEventListener
              ...
              : e.attachEvent && e.attachEvent('onunload', ea)), p = !f(
            g
      ...
      preFilter: {
        ...
        CHILD: function (a) {
          return a[1] = a[1].toLowerCase(), a[1].slice(0, 3) === 'nth'
            ? (a[3] || ga.error(a[0]), a[4] = +(a[4]
                ? a[5] + (a[6] || 1)
                : 2 * (a[3] === 'even' || a[3] === 'odd')), a[5] = +(a[7] +
                a[8] ||
                a[3] === 'odd'))
            : a[3] && ga.error(a[0]), a
        },
    ...
    function qa () {}
    qa.prototype = d.filters = d.pseudos, d.setFilters = new qa(), g = ga.tokenize = function (
      a,
      b
    ) {
    ...
    function wa (a, b, c, d, e, f) {
      return d && !d[u] && (d = wa(d)), e &&
        !e[u] &&
        (e = wa(e, f)), ia(function (f, g, h, i) {
          var j,
            k,
            l,
            m = [],
          ...
          if (f) {
            ...
            r = va(r === g ? r.splice(o, r.length) : r), e
            ? e(null, g, r, i)
            : H.apply(g, r)
          }
        })
  ...
  n.ready.promise = function (b) {
    return H ||
      (H = n.Deferred(), l.readyState === 'complete'
        ? setTimeout(n.ready)
  ...
  n.extend({
              ...
              if (f && void 0 === b) {
                ...
                this.each(function () {
                  ...
                  M.set(
                    ...
                    d,
                    b
                  ), a.indexOf('-') !== -1 && void 0 !== c && M.set(this, a, b)
                })
              }
            },
            null,
    ...
    dequeue: function (a, b) {
      ...
      e === 'inprogress' && (e = c.shift(), d--), e &&
        (b === 'fx' && c.unshift('inprogress'), delete f.stop, e.call(
          a,
          g,
          f
        )), !d && f && f.empty.fire()
    ...
    queue: function (a, b) {
      var c = 2
      return typeof a !== 'string' && (b = a, a = 'fx', c--), arguments.length <
        c
        ? n.queue(this[0], a)
        : void 0 === b
            ? this
  ...
  var Q = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source,
    ...
    S = function (a, b) {
      return a = b || a, n.css(a, 'display') === 'none' ||
  ...
  n.event = {
      ...
      if (
        (g = h = d = d || l, d.nodeType !== 3 &&
          ...
          (q.indexOf('.') >= 0 &&
            ...
            'on' + q, b = b[n.expando]
            ? b
            : new n.Event(q, typeof b === 'object' && b), b.isTrigger = e
            ? 2
            : 3, b.namespace = r.join('.'), b.namespace_re = b.namespace
            ? new RegExp('(^|\\.)' + r.join('\\.(?:.*\\.|)') + '(\\.|$)')
            : null, b.result = void 0, b.target || (b.target = d), c = c == null
            ? [b]
    ...
    fix: function (a) {
      ...
      return a.target || (a.target = l), a.target.nodeType === 3 &&
    ...
    n.each({ focus: 'focusin', blur: 'focusout' }, function (a, b) {
      ...
      off: function (a, b, c) {
        ...
        return (b === !1 || typeof b === 'function') && (c = b, b = void 0), c ===
        !1 &&
  ...
  n.extend({
    clone: function (a, b, c) {
      ...
      return g = oa(h, 'script'), g.length > 0 &&
        ma(g, !i && oa(a, 'script')), h
    },
    buildFragment: function (a, b, c, d) {
        ...
        if ((e = a[m], e || e === 0)) {
          if (n.type(e) === 'object') {
            ...
            f = f || k.appendChild(b.createElement('div')), g = (ba.exec(e) || [
              '',
              ''
            ])[1].toLowerCase(), h = ia[g] || ia._default, f.innerHTML = h[1] +
              e.replace(aa, '<$1></$2>') +
              h[2], j = h[0]
            while (j--) {
              f = f.lastChild
      ...
      while (e = l[m++]) {
        if (
          (!d || n.inArray(e, d) === -1) &&
          (i = n.contains(e.ownerDocument, e), f = oa(
            k.appendChild(e),
            'script'
          ), i && ma(f), c)
        ) {
    ...
    remove: function (a, b) {
      for (
        ...
        b || c.nodeType !== 1 || n.cleanData(oa(c)), c.parentNode &&
          (b &&
    ...
    empty: function () {
      for (var a, b = 0; (a = this[b]) != null; b++) {
        a.nodeType === 1 && (n.cleanData(oa(a, !1)), a.textContent = '')
      }
      return this
    },
    clone: function (a, b) {
      return a = a == null ? !1 : a, b = b == null
        ? a
        : b, this.map(function () {
    ...
    domManip: function (a, b) {
      ...
      if (
        ...
        (c = n.buildFragment(
          ...
          !1,
          this
        ), d = c.firstChild, c.childNodes.length === 1 && (c = d), d)
      ) {
        for (f = n.map(oa(c, 'script'), ka), g = f.length; l > j; j++) {
          h = c, j !== o &&
            (h = n.clone(h, !0, !0), g && n.merge(f, oa(h, 'script'))), b.call(
            this[j],
            h,
            j
          )
    ...
    return c ||
      (c = sa(a, b), (c !== 'none' && c) ||
        (qa = (qa ||
          ...
          b.documentElement
        ), b = qa[0].contentDocument, b.write(), b.close(), c = sa(
          a,
          b
        ), qa.detach()), ra[a] = c), c
  }
  ...
  function xa (a, b, c) {
    ...
    return c = c ||
      wa(
        a
      ), c && (g = c.getPropertyValue(b) || c[b]), c && (g !== '' || n.contains(a.ownerDocument, a) || (g = n.style(a, b)), va.test(g) && ua.test(b) && (d = h.width, e = h.minWidth, f = h.maxWidth, h.minWidth = h.maxWidth = h.width = g, g = c.width, h.width = d, h.minWidth = e, h.maxWidth = f)), void 0 !== g ? g + '' : g
  }
  function ya (a, b) {
    return {
      get: function () {
  ...
  !(function () {
    ...
    if (f.style) {
      f.style.backgroundClip = 'content-box', f.cloneNode(
        !0
      ).style.backgroundClip = '', k.clearCloneStyle = f.style.backgroundClip ===
        'content-box', e.style.cssText = 'border:0;width:0;height:0;top:0;left:-9999px;margin-top:1px;position:absolute', e.appendChild(
        f
      )
      function g () {
  ...
  function Ha (a, b, c, d, e) {
    for (
      ...
      f < 4;
      f += 2
    ) c === 'margin' && (g += n.css(a, c + R[f], !0, e)), d ? (c === 'content' && (g -= n.css(a, 'padding' + R[f], !0, e)), c !== 'margin' && (g -= n.css(a, 'border' + R[f] + 'Width', !0, e))) : (g += n.css(a, 'padding' + R[f], !0, e), c !== 'padding' && (g += n.css(a, 'border' + R[f] + 'Width', !0, e)))
    return g
  }
  function Ia (a, b, c) {
    var d = !0,
    ...
    if (e <= 0 || e == null) {
      if (
        (e = xa(a, b, f), (e < 0 || e == null) && (e = a.style[b]), va.test(e))
      ) {
        return e
      }
  ...
  function Ja (a, b) {
    for (
      ...
      h > g;
      g++
    ) d = a[g], d.style && (f[g] = L.get(d, 'olddisplay'), c = d.style.display, b ? (f[g] || c !== 'none' || (d.style.display = ''), d.style.display === '' && S(d) && (f[g] = L.access(d, 'olddisplay', ta(d.nodeName)))) : (e = S(d), (c === 'none' && e) || L.set(d, 'olddisplay', e ? c : n.css(d, 'display'))))
    for (
      g = 0;
      h > g;
      g++
  ...
  n.extend({
      ...
      if (a && a.nodeType !== 3 && a.nodeType !== 8 && a.style) {
        ...
        return b = n.cssProps[h] || (n.cssProps[h] = Fa(i, h)), g = n.cssHooks[
          ...
          : (f = typeof c, f === 'string' &&
              (e = Ba.exec(c)) &&
              (c = (e[1] + 1) * e[2] +
                parseFloat(n.css(a, b)), f = 'number'), c != null &&
              c === c &&
              (f !== 'number' ||
                n.cssNumber[h] ||
    ...
    css: function (a, b, c, d) {
      ...
      return b = n.cssProps[h] ||
        (n.cssProps[h] = Fa(a.style, h)), g = n.cssHooks[b] ||
        n.cssHooks[h], g && 'get' in g && (e = g.get(a, !0, c)), void 0 === e &&
        (e = xa(a, b, d)), e === 'normal' && b in Da && (e = Da[b]), c === '' ||
        c
    ...
    n.cssHooks[b] = {
      get: function (a, c, d) {
        return c
          ? za.test(n.css(a, 'display')) && a.offsetWidth === 0
      ...
      set: function (a, c, d) {
        ...
        return Ga(
          a,
          c,
          d ? Ha(a, b, d, n.css(a, 'boxSizing', !1, e) === 'border-box', e) : 0
        )
      }
    }
  ...
  n.Tween = Ka, Ka.prototype = {
    ...
    run: function (a) {
      ...
      return this.options.duration
        ...
        ? c.set(this)
        : Ka.propHooks._default.set(this), this
    }
  ...
  function Va (a, b, c) {
    var d,
      ...
      q = L.get(a, 'fxshow')
    c.queue ||
      (h = n._queueHooks(a, 'fx'), h.unqueued == null &&
    ...
    if (n.isEmptyObject(m)) {
      (j === 'none' ? ta(a.nodeName) : j) === 'inline' && (o.display = j)
    } else {
      ...
      for (d in m) {
        g = Ua(p ? q[d] : 0, d, l), d in q ||
          (q[d] = g.start, p &&
            (g.end = g.start, g.start = d === 'width' || d === 'height'
              ? 1
              : 0))
      }
    }
  ...
  n.Animation = n.extend(Xa, {
    ...
    return d.duration = n.fx.off
      ...
      : typeof d.duration === 'number'
          ...
          : d.duration in n.fx.speeds
              ...
              : n.fx.speeds._default, (d.queue == null || d.queue === !0) &&
    ...
    stop: function (a, b, c) {
      ...
      return typeof a !== 'string' && (c = b, b = a, a = void 0), b &&
        a !== !1 &&
    ...
    a.type = 'checkbox', k.checkOn = a.value !== '', k.optSelected = c.selected, b.disabled = !0, k.optDisabled = !c.disabled, a = l.createElement('input'), a.value = 't', a.type = 'radio', k.radioValue = a.value === 't'
  })()
        ...
        return typeof a.getAttribute === U
          ...
          : ((f === 1 && n.isXMLDoc(a)) ||
              (b = b.toLowerCase(), d = n.attrHooks[b] ||
                (n.expr.match.bool.test(b) ? Za : Ya)), void 0 === c
      ...
      var b, c, d, e = this[0]
      {
        if (arguments.length) {
          return d = n.isFunction(a), this.each(function (c) {
            var e
            this.nodeType === 1 &&
              (e = d ? a.call(this, c, n(this).val()) : a, e == null
                ? e = ''
                : typeof e === 'number'
                    ? e += ''
                    : n.isArray(e) &&
    ...
    ajax: function (a, b) {
      ...
      if (
        (o.promise(
          ...
          ob) + '')
          .replace(eb, '')
          .replace(jb, pb[1] + '//'), k.type = b.method ||
          b.type ||
          k.method ||
          k.type, k.dataTypes = n
          .trim(k.dataType || '*')
          .toLowerCase()
          .match(E) || [''], k.crossDomain == null &&
          (h = kb.exec(k.url.toLowerCase()), k.crossDomain = !(!h ||
            (h[1] === pb[1] &&
              h[2] === pb[2] &&
              (h[3] || (h[1] === 'http:' ? '80' : '443')) ===
                (pb[3] || (pb[1] === 'http:' ? '80' : '443'))))), k.data &&
          k.processData &&
          typeof k.data !== 'string' &&
          (k.data = n.param(k.data, k.traditional)), rb(lb, k, b, v), t === 2)
      ) {
        return v
      }
      i = n.event && k.global, i &&
        ...
        n.event.trigger(
          'ajaxStart'
        ), k.type = k.type.toUpperCase(), k.hasContent = !ib.test(
        k.type
      ...
      function x (a, b, f, h) {
        ...
        t !== 2 &&
          (t = 2, g && clearTimeout(g), c = void 0, e = h ||
            '', v.readyState = a > 0 ? 4 : 0, j = (a >= 200 && a < 300) ||
            a === 304, f && (u = tb(k, v, f)), u = ub(k, u, v, j), j
            ? (k.ifModified &&
                (w = v.getResponseHeader('Last-Modified'), w &&
                  (n.lastModified[d] = w), w = v.getResponseHeader('etag'), w &&
                  (n.etag[d] = w)), a === 204 || k.type === 'HEAD'
                ? x = 'nocontent'
                : a === 304
                    ? x = 'notmodified'
  ...
  a.attachEvent &&
    ...
    'withCredentials' in Eb, k.ajax = Eb = !!Eb, n.ajaxTransport(function (a) {
      var b
      ...
      ? {
        send: function (c, d) {
          ...
          b = function (a) {
            return function () {
              b &&
                  (delete Cb[g], b = f.onload = f.onerror = null, a === 'abort'
                    ? f.abort()
                    : a === 'error'
          ...
          : b.jsonp !== !1 &&
              (b.url += (db.test(b.url) ? '&' : '?') +
                ...
                e), b.converters['script json'] = function () {
                  ...
                  a[
            e
          ] = f, b[e] && (b.jsonpCallback = c.jsonpCallback, Fb.push(e)), g && n.isFunction(f) && f(g[0]), g = f = void 0
                }), 'script')
      : void 0
  ...
  n.fn.load = function (a, b, c) {
    if (typeof a !== 'string' && Hb) return Hb.apply(this, arguments)
    var d, e, f, g = this, h = a.indexOf(' ')
    return h >= 0 && (d = n.trim(a.slice(h)), a = a.slice(0, h)), n.isFunction(
      b
    )
      ? (c = b, b = void 0)
      : b && typeof b === 'object' && (e = 'POST'), g.length > 0 &&
      n
  ...
  n.offset = {
    setOffset: function (a, b, c) {
      ...
      k === 'static' &&
        ...
        a,
        'top'
      ), i = n.css(a, 'left'), j = (k === 'absolute' || k === 'fixed') &&
        (f + i).indexOf('auto') > -1, j
        ? (d = l.position(), g = d.top, e = d.left)
        : (g = parseFloat(f) || 0, e = parseFloat(i) || 0), n.isFunction(b) &&
        (b = b.call(a, c, h)), b.top != null &&
        (m.top = b.top - h.top + g), b.left != null &&
      ...
      if (f) {
        return b = f.documentElement, n.contains(b, d)
          ? (typeof d.getBoundingClientRect !== U &&
              (e = d.getBoundingClientRect()), c = Jb(f), {
    ...
    offsetParent: function () {
      return this.map(function () {
        ...
        while (
          a && !n.nodeName(a, 'html') && n.css(a, 'position') === 'static'
        ) a = a.offsetParent
        return a || Ib
      })
    }
    ...
    return this.length
  }, n.fn.andSelf = n.fn.addBack, typeof define === 'function' &&
    define.amd &&
