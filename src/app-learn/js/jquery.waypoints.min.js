...
!(function () {
  ...
  function t (o) {
    ...
    this.key = 'waypoint-' + e, this.options = t.Adapter.extend(
      ...
      (this.options.offset = t.offsetAliases[
        this.options.offset
      ]), this.group.add(this), this.context.add(this), i[
      this.key
    ] = this, e += 1
  }
  var e = 0, i = {}
  ...
  function e (t) {
    this.element = t, this.Adapter = n.Adapter, this.adapter = new this.Adapter(
      ...
      i, this.didScroll = !1, this.didResize = !1, this.oldScroll = {
        ...
        vertical: {},
        horizontal: {}
      }, t.waypointContextKey = this.key, o[
      t.waypointContextKey
    ] = this, i += 1, this.createThrottledScrollHandler(), this.createThrottledResizeHandler()
  }
    ...
    for (var r in t) {
      ...
      for (var a in this.waypoints[r]) {
        ...
        d.element !== d.element.window &&
          (y = d.adapter.offset()[s.offsetProp]), typeof f === 'function'
          ? f = f.apply(d)
          : typeof f === 'string' &&
              (f = parseFloat(f), d.options.offset.indexOf('%') > -1 &&
                (f = Math.ceil(
                  s.contextDimension * f / 100
                ))), l = s.contextScroll - s.contextOffset, d.triggerPoint = y +
          l -
          f, h = w < s.oldScroll, p = d.triggerPoint >= s.oldScroll, u = h &&
          p, c = !h && !p, !g && u
  ...
  function i (t) {
    this.name = t.name, this.axis = t.axis, this.id = this.name +
      '-' +
      this.axis, this.waypoints = [], this.clearTriggerQueues(), o[this.axis][
      this.name
    ] = this
  }
  ...
  i.prototype.add = function (t) {
    ...
    for (var i in this.triggerQueues) {
      var o = this.triggerQueues[i], n = i === 'up' || i === 'left'
      o.sort(n ? e : t)
  ...
  function t (t) {
    return function () {
      ...
      return t.isFunction(arguments[0]) &&
        (o = t.extend({}, arguments[1]), o.handler = arguments[
          0
        ]), this.each(function () {
