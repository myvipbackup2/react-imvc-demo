...
!(function (a) {
    ...
    (function (a) {
      ...
      return f.id = 'mq-test-1', f.style.cssText = 'position:absolute;top:-100em', e.style.background = 'none', e.appendChild(
        ...
        return f.innerHTML = '&shy;<style media="' +
          ...
          e,
          d
        ), b = f.offsetWidth === 42, c.removeChild(e), { matches: b, media: a }
      }
    })(a.document)
})(this), (function (a) {
  'use strict'
  ...
  if (
    ...
    var g,
      ...
      t = function () {
        ...
        return b.style.cssText = 'position:absolute;font-size:1em;width:1em', c ||
          (c = f = j.createElement(
            'body'
          ), c.style.background = 'none'), k.style.fontSize = '100%', c.style.fontSize = '100%', c.appendChild(
          b
        ), f && k.insertBefore(c, k.firstChild), a = b.offsetWidth, f
          ? k.removeChild(c)
          : c.removeChild(b), k.style.fontSize = d, e &&
          (c.style.fontSize = e), a = i = parseFloat(a)
      },
      u = function (b) {
        var c = 'clientWidth',
          d = k[c],
          e = (j.compatMode === 'CSS1Compat' && d) || j.body[c] || d,
          f = {},
          o = s[s.length - 1],
          r = new Date().getTime()
        ...
        for (var v in l) {
          if (l.hasOwnProperty(v)) {
            var w = l[v],
              ...
              A = y === null,
              B = 'em'
            x && (x = parseFloat(x) * (x.indexOf(B) > -1 ? i || t() : 1)), y &&
              (y = parseFloat(y) *
                (y.indexOf(B) > -1 ? i || t() : 1)), (w.hasquery &&
              ((z && A) || !(z || e >= x) || !(A || y >= e))) ||
        ...
        for (var D in f) {
          if (f.hasOwnProperty(D)) {
            ...
            E.type = 'text/css', E.media = D, q.insertBefore(
              E,
              o.nextSibling
            ), E.styleSheet
              ? E.styleSheet.cssText = F
              : E.appendChild(j.createTextNode(F)), n.push(E)
          }
        }
      },
      v = function (a, b, d) {
        ...
        for (var i = 0; f > i; i++) {
          ...
          h
            ? (j = d, m.push(g(a)))
            : (j = e[i].match(c.regex.findStyles) && RegExp.$1, m.push(
                RegExp.$2 && g(RegExp.$2)
              )), n = j.split(','), o = n.length
          for (var p = 0; o > p; p++) {
            k = n[p], l.push({
              media: (k.split('(')[0].match(c.regex.only) && RegExp.$2) ||
                'all',
              rules: m.length - 1,
      ...
      w = function () {
        if (d.length) {
          var b = d.shift()
          f(b.href, function (c) {
            v(c, b.href, b.media), o[b.href] = !0, a.setTimeout(
              function () {
                w()
              },
              0
      ...
      x = function () {
        for (var b = 0; b < s.length; b++) {
          var c = s[b],
            e = c.href,
            f = c.media,
            g = c.rel && c.rel.toLowerCase() === 'stylesheet'
          e &&
            g &&
            !o[e] &&
            (c.styleSheet && c.styleSheet.rawCssText
              ...
              : ((!/^([a-zA-Z:]*\/\/)/.test(e) && !r) ||
                  ...
                  (e.substring(0, 2) === '//' &&
                    (e = a.location.protocol + e), d.push({
                      href: e,
                      media: f
                    })))
        }
    ...
    x(), c.update = x, c.getEmValue = t, a.addEventListener
