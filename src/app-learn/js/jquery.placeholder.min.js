...
!(function (a) {
  typeof define === 'function' && define.amd
    ? define(['jquery'], a)
    : a(
        typeof module === 'object' && module.exports ? require('jquery') : jQuery
      )
})(function (a) {
  function b (b) {
    var c = {}, d = /^jQuery\d+$/
  ...
  function c (b, c) {
    ...
    if (
      ...
      if (
        (d.value = '', f.removeClass(n.customClass), f.data(
        ...
        if (
          (f = f
            ...
            .show()
            .attr('id', f.removeAttr('id').data('placeholder-id')), b === !0)
        ) {
  ...
  function d (d) {
    ...
    if (!d || d.type !== 'blur' || !g.hasClass(n.customClass)) {
      if (f.value === '') {
        if (f.type === 'password') {
        ...
        g.addClass(n.customClass), g[0].value = g.attr(
  ...
  var f,
    g,
    h = !1,
    i = Object.prototype.toString.call(window.operamini) ===
      '[object OperaMini]',
  ...
  j && k
    ? (g = a.fn.placeholder = function () {
      return this
    }, g.input = !0, g.textarea = !0)
    : (g = a.fn.placeholder = function (b) {
      var e = { customClass: 'placeholder' }
      return n = a.extend({}, e, b), this.filter(
            (j ? 'textarea' : ':input') +
              '[' +
              (h ? 'placeholder-x' : 'placeholder') +
              ']'
      ...
      set: function (b, f) {
        var g, h, i = a(b)
        return f !== '' &&
            (g = i.data('placeholder-textinput'), h = i.data(
              'placeholder-password'
            ), g
              ? (c.call(g[0], !0, f) || (b.value = f), g[0].value = f)
              : h &&
                  (c.call(b, !0, f) || (h[0].value = f), b.value = f)), i.data(
            'placeholder-enabled'
          )
            ? (f === ''
                ? (b.value = f, b != e() && d.call(b))
                : (i.hasClass(n.customClass) && c.call(b), b.value = f), i)
            : (b.value = f, i)
      }
    }, j || (l.input = f, m.value = f), k ||
        (l.textarea = f, m.value = f), a(function () {
